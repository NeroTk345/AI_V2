...
# We importeren nu de functies en variabelen uit de aangepaste tokenizer
from tokenizer import initialize_tokenizer, encode, save_tokenizer, text, vocab_size as tokenizer_vocab_size
# Importeer alles uit config.py
from config import *

# --- DE OPLOSSING VOOR SNELHEID EN STABILITEIT ---
...
def train_model(save_path='checkpoints/gpt_model.pth'):
    ...
    # Deze functie vult de 'text' variabele in tokenizer.py
    initialize_tokenizer()
    # Nu kunnen we de 'text' variabele veilig gebruiken
