...
eval_interval = 500
learning_rate = 3e-4 # Meestal is het beter om deze niet te veranderen
eval_iters = 200

n_embd = 768         # Breder model
n_head = 12          # Meer aandachtskoppen (768 is deelbaar door 12)
n_layer = 12         # Dieper model
dropout = 0.2
