...
def prepare_whatsapp_style_dataset(
    ...
    try:
        # We laden alleen de Nederlands-Nederlands 'bitext'. streaming=True is efficiënt.
        dataset = load_dataset("open_subtitles", lang1="nl", lang2="nl", split="train", streaming=True, trust_remote_code=True)
